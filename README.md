...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-compare-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7145&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-compare-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-compare` can be installed with:

```
conda install r-compare
```

It is possible to list all of the versions of `r-compare` available on your platform with:
